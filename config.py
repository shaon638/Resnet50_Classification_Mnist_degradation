...
exp_name = f"{model_arch_name}-Mnist1_7M"

if mode == "train":
    # Dataset address
    train_image_dir = "/ssd_scratch/cvit/shaon/ImageNet/train"
    valid_image_dir = "/ssd_scratch/cvit/shaon/ImageNet/val"
    ...
    pretrained_model_weights_path = "/ssd_scratch/cvit/shaon/ResNet-PyTorch/results/resnet50-Mnist1_6M/last.pth.tar"

    # Incremental training and migration training
    resume = "/ssd_scratch/cvit/shaon/ResNet-Pytorch/samples/resnet50-Mnist1_6M/epoch_5.pth.tar"
...
if mode == "test":
    # Test data address
    test_image_dir = "/ssd_scratch/cvit/shaon/ImageNet_test/test"
